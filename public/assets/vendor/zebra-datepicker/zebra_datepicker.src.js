...
(function(factory) {
    ...
    $.Zebra_DatePicker = function(element, options) {
        ...
        var defaults = {
                ...
                lang_clear_date: 'Effacer la date',
                ...
                if (!(plugin.settings.always_visible instanceof jQuery)) {
                    ...
                    if (!update) {
                        ...
                        if (plugin.settings.show_icon) {
                            ...
                            icon = $('<button type="button" class="Zebra_DatePicker_Icon' + ($element.attr('disabled') === 'disabled' ? ' Zebra_DatePicker_Icon_Disabled' : '') + '">Choisissez une date</button>');
